...
impl GamesRepository {
    ...
    pub async fn insert(db: &DatabaseConnection, game: InsertGameData) -> Result<i32, DbErr> {
        ...
        let game_active = games::ActiveModel {
            ...
            le_launch: NotSet,
            magpie: NotSet,
            bgm_sync_status: Set(game.bgm_sync_status),
            vndb_sync_status: Set(game.vndb_sync_status),
    ...
    pub async fn update(
        ...
        let game_active = games::ActiveModel {
            ...
            bgm_sync_status: updates.bgm_sync_status.map_or(NotSet, Set),
            vndb_sync_status: updates.vndb_sync_status.map_or(NotSet, Set),
    ...
    pub async fn update_batch(
        ...
        for (game_id, update) in updates {
            ...
            let game_active = games::ActiveModel {
                ...
                bgm_sync_status: update.bgm_sync_status.map_or(NotSet, Set),
                vndb_sync_status: update.vndb_sync_status.map_or(NotSet, Set),
